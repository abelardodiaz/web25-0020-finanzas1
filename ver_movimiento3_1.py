...
# Cargar archivo 3 y mostrar movimiento #1
...
if len(df_clean) > 0:
    mov = df_clean.iloc[0]  # Movimiento #1
    print("📌 MOVIMIENTO #1 (Archivo 3):")
    ...
    print(f"\n📊 Total movimientos en archivo 3: {len(df_clean)}")
else:
    print("No hay movimientos en archivo 3")